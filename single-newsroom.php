<?php 
/* Template Name: Single Newsroom Template
 * Template Newsroom Type: newsroom, page
 */
/**
 * Single Newsroom Default template
 *
 * @package SDEV
 * @subpackage SDEV WP
 ...
 */
    ...
    $SidebarDesc = get_field('sidebar_description');
    $SidebarButton = get_field('sidebar_button');
    $SidebarRelatedDesc = get_field('sidebar_related_description');
    ...
    if($blogs) {
        foreach($blogs as $services) {
            ...
            $results[$post_id] = [
                ...
                'image' => get_field('ns_image', $post_id)
            ];
        }
    }
    ...
    get_header(); ?>
        ...
        <div id="page-content" class="page-blocks page-blocks__single-news" data-tpl="single">
                ...
                <div class="single-news-wrap">
                    <div class="single-news-banner">
                        <div class="single-news-banner-inner">
                            ...
                            <img src="<?= \SDEV\Utils::getThemeResourcePath('assets/images/banner.jpg') ?>" alt="View all" /><?= $FinLink['title'] ?>
                        </div>
                    </div>
                    <div class="single-news-desc-wrap">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="single-date">
                                                    ...
                                                    <div class="icon-desc">
                                                        <?php if(get_field('author_news_page')):
                                                                $post_data = get_post(get_field('author_news_page'));  
                                                            ?>
                            ...
                            <div class="single-news-desc-right single-news-desc-col">
                                <div class="single-news-desc-right-inner">
                                    <div class="single-news-side">
                                        ...
                                        <div class="single-news-side-item">
                                                <?php if(get_field('sidebar_related_page')):
                                                        $post_data_rel = get_post(get_field('sidebar_related_page'));  
                                                    ?>
                                        ...
                                        <div class="single-news-side-item">
                                            <?php if(get_field('author_news_page')):
                                                    $post_data_team = get_post(get_field('author_news_page'));  
                                            ...
                                            <div class="single-news-side-item-inner">
                                                ...
                                                <div class="single-news-team-link">
                                                    <a href="">Learn more about the author</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="single-team-art" data-sal="slide-up" data-sal-duration="800">
                            <div class="single-team-art-inner single-team-desk">
                                <div class="single-team-art-title">
                                    Related Posts
                                </div>
                                <div class="single-related-desc">
                                    ...
                                    <?php if($results) : ?>
                                        <div class="single-team-art-list">
                                            <?php foreach($results as $latestnews):?>
                                                <?php if($latestnews): 
                                                     $categorys = get_the_category(get_the_ID(), 'category');
                                                    ?>
            ...
            <div class="team-col-logo" data-sal="slide-up" data-sal-duration="800">
                <div class="tcl-inner">
